    ...
    return (
        <>
            <div className="footer">
                <div className="footer-container">
                    <div className="footer-content">
                        <Link to="/" className="d-inline-flex link-body-emphasis text-decoration-none logo">
                            <img src="log.png" width={30} alt="" />
                            <h1 style={{ fontWeight: 400, fontSize: '1.8vw' }}>ShipEase</h1>
                        </Link>
                        ...
                        <h2 style={{ fontSize: '1.5vw', marginTop: '35px' }}>Reach Us At</h2>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginTop: '-15px' }}>
                            <img src="email.png" width={20} height={14} alt="" />
                            <p style={{ marginTop: '12px', color: '#7A7A7A' }}>support@shipease.com</p>
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginTop: '-15px' }}>
                            <img src="location.png" width={20} height={19} alt="" />
                            <p style={{ marginTop: '12px', color: '#636363', fontWeight: 700 }}>Office Address:</p>
                        </div>
                        <p style={{ color: '#7A7A7A', fontSize: '15px', fontWeight: 400, marginTop: '-12px', marginLeft: '25px' }}>Parul Univetsity,P.O. Limbda,Dist. Vdodara,<br />Gujarat,391760</p>
                    </div>
                ...
                <div style={{ width: '100%', padding: '22px 32px', marginTop: '10px' }}>
                    <p style={{ color: 'white' }}>© 2024 ShipEase. All rights reserved.</p>
                </div>
            </div>
        </>
    )
